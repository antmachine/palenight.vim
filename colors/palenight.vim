...
call s:h("CursorColumn", {"fg": s:purple, "bg": s:cursor_grey }) " the screen column that the cursor is in when 'cursorcolumn' is set
call s:h("CursorLine", { "fg": s:purple, "bg": s:cursor_grey }) " the screen line that the cursor is in when 'cursorline' is set
...
" call s:h("MatchParen", { "fg": s:black, "bg": s:red, "gui": "bold" }) " The character under the cursor or just before it, if it is a paired bracket, and its match.
...
call s:h("TabLine", { "fg": s:comment_grey, "bg": s:comment_grey }) " tab pages line, not active tab page label
call s:h("TabLineFill", {}) " tab pages line, where there are no labels
call s:h("TabLineSel", { "fg": s:white, "bg": s:comment_grey }) " tab pages line, active tab page label
...
" Set this in ~/.config/nvim/.init.vim
" set background=dark
