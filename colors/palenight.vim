...
call s:h("CursorColumn", {"fg": s:green, "bg": s:cursor_grey }) " the screen column that the cursor is in when 'cursorcolumn' is set
call s:h("CursorLine", { "fg": s:green, "bg": s:cursor_grey }) " the screen line that the cursor is in when 'cursorline' is set
